...
<script>
import { listRanking, getRanking, delRanking, addRanking, updateRanking, exportRanking } from "@/api/bajiaostar/ranking";
...
  },
  ...
  methods: {
    ...
    getList() {
      ...
      listRanking(this.newQueryParams).then(response => {
