  ...
  <div class="app-container">
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleAdd"
          v-hasPermi="['bajiaostar:notice:add']"
        >新增</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="single"
          @click="handleUpdate"
          v-hasPermi="['bajiaostar:notice:edit']"
        >修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['bajiaostar:notice:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['bajiaostar:notice:export']"
        >导出</el-button>
      </el-col>
        ...
        <template slot-scope="scope">
          ...
          >删除</el-button>
           <el-button
            ...
            @click="pushInfo(scope.row.id)"
            v-hasPermi="['bajiaostar:notice:push']"
          >推送</el-button>
        </template>
      </el-table-column>
    </el-table>
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body :close-on-click-modal = "false">
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="通知内容" prop="content">
          <el-input v-model="form.content" type = "textarea" placeholder="请输入通知内容" maxlength = "120" />
        </el-form-item>
        <!-- <el-form-item label="被通知用户id" prop="userId">
          <el-input v-model="form.userId" placeholder="请输入被通知用户id" />
        </el-form-item> -->
        <!-- <el-form-item label="推送返回内容" prop="pushResult">
          <el-input v-model="form.pushResult" placeholder="请输入推送返回内容" />
        </el-form-item> -->
      </el-form>
...
<script>
import { listNotice, getNotice, delNotice, addNotice, updateNotice, exportNotice, pushNotice } from "@/api/bajiaostar/notice";
