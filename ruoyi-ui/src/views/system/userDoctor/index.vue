...
<script>
import { doctorsUser, getUser, delUser, addUser, updateUser, exportUser, resetUserPwd, changeUserStatus, importTemplate } from "@/api/system/user";
...
  },
  ...
  methods: {
    ...
    getList() {
      this.loading = true;
      doctorsUser(this.addDateRange(this.queryParams, this.dateRange)).then(response => {
