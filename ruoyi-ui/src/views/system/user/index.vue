...
<script>
import { listSysUser, getUser, delUser, addUser, updateUser, exportUser, resetUserPwd, changeUserStatus, importTemplate } from "@/api/system/user";
...
  },
  ...
  methods: {
    ...
    getList() {
      this.loading = true;
      listSysUser(this.addDateRange(this.queryParams, this.dateRange)).then(response => {
